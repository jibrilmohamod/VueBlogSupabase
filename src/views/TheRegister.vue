 ...
 <body>
  <div class="bg-indigo-50">
   <form
    ...
    class="xl:px-20 md:px-10 sm:px-6 px-4 md:py-12 py-9 2xl:mx-auto 2xl:container md:flex items-center justify-center h-[93vh]"
   >
    <div
    ...
    >
     ...
     <div class="text-red-600 justify-self-center text-sm mt-1 h-6 w-full">
     ...
     <!-- <div>
      ...
      <input
       ...
       type="text"
       class="bg-gray-200 border rounded text-xs font-medium leading-none placeholder-gray-500 text-gray-800 py-3 w-full pl-3 mt-2"
